    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mongoose_1.default.connect("mongodb+srv://sciAdmin:sciAdminPwd123@scisubmit.stdc0.mongodb.net/scisubmit?retryWrites=true&w=majority", {
                        dbName: "scisubmit",
                    })];
            case 1:
                // Connect to your MongoDB database
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Error updating database:", error_1);
                return [3 /*break*/, 6];
            case 4: 
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, updateDatabase()];
            case 1:
                _a.sent(); // Ensure the Promise is handled
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                console.error("Error running the database update script:", error_2);
                return [3 /*break*/, 3];
