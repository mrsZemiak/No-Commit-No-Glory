      ...
      <v-card-text>
        <v-form ref="userForm">
          ...
          <v-select
            ...
            dense
          />
          <v-radio-group v-model="selectedUser.role" row label="Role">
  ...
  setup() {
    ...
    const fetchUsers = async () => {
      try {
        ...
        showSnackbar({
          message: 'Nepodarilo sa načítať používateľov',
          color: 'error',
        })
      }
    }
      ...
      try {
        if (dialogMode.value === 'edit') {
          ...
          await axiosInstance.patch(
            `/auth/admin/users/${selectedUser.value._id}`,
            userPayload,
          )
        ...
        showSnackbar({
          message: 'Nepodarilo sa uložiť používateľa',
          color: 'error',
        })
      }
    }
